...
public class DocGeneratingForm : BaseXtraForm
{
	...
	private BarButtonItem openReportBarButtonItem;

	private OpenFileDialog xtraReportOpenFileDialog;

	private BarButtonItem saveReportBarButtonItem;

	private RibbonPageGroup ribbonPageGroup1;

	public DocGeneratingForm(int databaseId)
	{
		InitializeComponent();
		this.databaseId = databaseId;
	}

	private void openReportBarButtonItem_ItemClick(object sender, ItemClickEventArgs e)
	{
		if (xtraReportOpenFileDialog.ShowDialog() != DialogResult.OK)
		{
			return;
		}
		XtraReport xtraReport = XtraReport.FromFile(xtraReportOpenFileDialog.FileName);
		xtraReport.Tag = xtraReportOpenFileDialog.FileName;
		int objectOrder = 1;
		List<DatabaseRow> documentations = new List<DatabaseRow>();
		documentations.AddRange(from x in DB.Database.GetData()
			select new DatabaseRow(x) into x
			orderby x.Title
			where x.Title.Contains("TEST")
			select x);
		DocumentationModulesContainer documentationModulesContainer = new DocumentationModulesContainer();
		foreach (DatabaseRow item2 in documentations)
		{
			List<ModuleRow> list = new List<ModuleRow>();
			list.AddRange(from x in DB.Module.GetDataByDatabaseWithoutDescription(item2.IdValue)
				select new ModuleRow(x) into x
				where x.Name.Contains("TEST")
				select x);
			...
			documentationModulesContainer.Data.Add(item);
		}
		...
		customFieldsSupport.Fields.ForEach(delegate(CustomFieldRowExtended x)
		{
			x.IsSelected = true;
		});
		DocGeneratingOptions docGeneratingOptions = new DocGeneratingOptions(customFieldsSupport)
		{
			DocumentationsModulesData = documentationModulesContainer
		};
		docGeneratingOptions.ExcludedObjects = new List<ObjectTypeHierarchy>();
		docGeneratingOptions.ExcludedObjects.Add(new ObjectTypeHierarchy(SharedObjectTypeEnum.ObjectType.Table, SharedObjectTypeEnum.ObjectType.Dependency));
		docGeneratingOptions.ExcludedObjects.Add(new ObjectTypeHierarchy(SharedObjectTypeEnum.ObjectType.View, SharedObjectTypeEnum.ObjectType.Dependency));
		docGeneratingOptions.ExcludedObjects.Add(new ObjectTypeHierarchy(SharedObjectTypeEnum.ObjectType.Procedure, SharedObjectTypeEnum.ObjectType.Dependency));
		docGeneratingOptions.ExcludedObjects.Add(new ObjectTypeHierarchy(SharedObjectTypeEnum.ObjectType.Function, SharedObjectTypeEnum.ObjectType.Dependency));
		RootDoc rootDoc = new RootDoc(docGeneratingOptions);
		rootDoc.Documentations = documentations.Select((DatabaseRow x) => new DatabaseDoc(rootDoc, x.IdValue, docGeneratingOptions, objectOrder++, documentations.Count(), this)).ToList();
	...
	private void saveReportBarButtonItem_ItemClick(object sender, ItemClickEventArgs e)
	{
		if (reportDesigner1.ActiveDesignPanel.Report.Tag is string fileName)
		{
			reportDesigner1.ActiveDesignPanel.SaveReport(fileName);
		}
		else
		{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Dataedo.App.Forms.DocGeneratingForm));
		...
		DevExpress.XtraReports.UserDesigner.XRDesignPanelListener xRDesignPanelListener = new DevExpress.XtraReports.UserDesigner.XRDesignPanelListener();
		...
		this.saveReportBarButtonItem = new DevExpress.XtraBars.BarButtonItem();
		...
		this.xtraReportOpenFileDialog = new System.Windows.Forms.OpenFileDialog();
		...
		this.ribbonControl1.Items.AddRange(new DevExpress.XtraBars.BarItem[125]
		{
			...
			this.openReportBarButtonItem,
			this.saveReportBarButtonItem
		});
		this.ribbonControl1.Location = new System.Drawing.Point(0, 0);
		this.ribbonControl1.MaxItemId = 125;
		this.ribbonControl1.Name = "ribbonControl1";
		this.ribbonControl1.PageCategories.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPageCategory[1] { this.xrToolboxPageCategory1 });
		this.ribbonControl1.Pages.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPage[3] { this.ribbonPage1, this.ribbonPage4, this.ribbonPage3 });
		this.ribbonControl1.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[4] { this.recentlyUsedItemsComboBox1, this.designRepositoryItemComboBox1, this.repositoryItemProgressBar1, this.repositoryItemZoomTrackBar1 });
		this.ribbonControl1.Size = new System.Drawing.Size(1601, 142);
		...
		this.commandBarItem31.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_NewReport;
		this.commandBarItem31.Id = 33;
		this.commandBarItem31.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_NewReportLarge;
		this.commandBarItem31.Name = "commandBarItem31";
		superToolTip.FixedTooltipWidth = true;
		toolTipTitleItem.Text = "New Blank Report";
		toolTipItem.LeftIndent = 6;
		toolTipItem.Text = "Create a new blank report.";
		superToolTip.Items.Add(toolTipTitleItem);
		superToolTip.Items.Add(toolTipItem);
		superToolTip.MaxWidth = 210;
		this.commandBarItem31.SuperTip = superToolTip;
		...
		this.commandBarItem34.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_OpenFile;
		this.commandBarItem34.Id = 36;
		this.commandBarItem34.ItemShortcut = new DevExpress.XtraBars.BarShortcut(System.Windows.Forms.Keys.O | System.Windows.Forms.Keys.Control);
		this.commandBarItem34.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_OpenFileLarge;
		...
		this.commandBarItem32.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_SaveFile;
		this.commandBarItem32.Id = 34;
		this.commandBarItem32.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_SaveFileLarge;
		...
		this.commandBarItem33.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_SaveAll;
		this.commandBarItem33.Id = 35;
		this.commandBarItem33.ItemShortcut = new DevExpress.XtraBars.BarShortcut(System.Windows.Forms.Keys.L | System.Windows.Forms.Keys.Control);
		this.commandBarItem33.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_SaveAllLarge;
		...
		this.commandBarItem52.ItemShortcut = new DevExpress.XtraBars.BarShortcut(System.Windows.Forms.Keys.F4 | System.Windows.Forms.Keys.Control);
		...
		this.commandBarItem53.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_Exit;
		this.commandBarItem53.Id = 59;
		this.commandBarItem53.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_ExitLarge;
		...
		this.commandBarItem1.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_AlignToGrid;
		...
		this.commandBarItem2.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_AlignLeft;
		...
		this.commandBarItem3.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_AlignVerticalCenters;
		...
		this.commandBarItem4.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_AlignRight;
		...
		this.commandBarItem5.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_AlignTop;
		...
		this.commandBarItem6.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_AlignHorizontalCenters;
		...
		this.commandBarItem7.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_AlignBottom;
		...
		this.commandBarItem8.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_SizeToControlWidth;
		...
		this.commandBarItem9.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_SizeToGrid;
		...
		this.commandBarItem10.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_SizeToControlHeight;
		...
		this.commandBarItem11.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_SizeToControl;
		...
		this.commandBarItem12.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_HorizSpaceMakeEqual;
		...
		this.commandBarItem13.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_HorizSpaceIncrease;
		...
		this.commandBarItem14.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_HorizSpaceDecrease;
		...
		this.commandBarItem15.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_HorizSpaceConcatenate;
		...
		this.commandBarItem16.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_VertSpaceMakeEqual;
		...
		this.commandBarItem17.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_VertSpaceIncrease;
		...
		this.commandBarItem18.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_VertSpaceDecrease;
		...
		this.commandBarItem19.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_VertSpaceConcatenate;
		...
		this.commandBarItem20.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_CenterHorizontally;
		...
		this.commandBarItem21.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_CenterVertically;
		...
		this.commandBarItem22.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_BringToFront;
		...
		this.commandBarItem23.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_SendToBack;
		...
		this.commandBarItem24.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_FontBold;
		this.commandBarItem24.Id = 24;
		this.commandBarItem24.ItemShortcut = new DevExpress.XtraBars.BarShortcut(System.Windows.Forms.Keys.B | System.Windows.Forms.Keys.Control);
		...
		this.commandBarItem25.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_FontItalic;
		this.commandBarItem25.Id = 25;
		this.commandBarItem25.ItemShortcut = new DevExpress.XtraBars.BarShortcut(System.Windows.Forms.Keys.I | System.Windows.Forms.Keys.Control);
		...
		this.commandBarItem26.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_FontUnderline;
		this.commandBarItem26.Id = 26;
		this.commandBarItem26.ItemShortcut = new DevExpress.XtraBars.BarShortcut(System.Windows.Forms.Keys.U | System.Windows.Forms.Keys.Control);
		...
		this.commandBarItem27.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_JustifyLeft;
		...
		this.commandBarItem28.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_JustifyCenter;
		...
		this.commandBarItem29.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_JustifyRight;
		...
		this.commandBarItem30.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_JustifyJustify;
		...
		this.commandBarItem35.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_NewReport;
		this.commandBarItem35.Id = 37;
		this.commandBarItem35.ItemShortcut = new DevExpress.XtraBars.BarShortcut(System.Windows.Forms.Keys.N | System.Windows.Forms.Keys.Control);
		this.commandBarItem35.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_NewReportLarge;
		...
		this.commandBarItem36.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_NewReportWizard;
		this.commandBarItem36.Id = 38;
		this.commandBarItem36.ItemShortcut = new DevExpress.XtraBars.BarShortcut(System.Windows.Forms.Keys.W | System.Windows.Forms.Keys.Control);
		this.commandBarItem36.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_NewReportWizardLarge;
		...
		this.commandBarItem37.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_SaveFile;
		this.commandBarItem37.Id = 39;
		this.commandBarItem37.ItemShortcut = new DevExpress.XtraBars.BarShortcut(System.Windows.Forms.Keys.S | System.Windows.Forms.Keys.Control);
		this.commandBarItem37.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_SaveFileLarge;
		...
		this.commandBarItem38.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_SaveFileAs;
		this.commandBarItem38.Id = 40;
		this.commandBarItem38.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_SaveFileAsLarge;
		...
		this.commandBarItem39.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_Cut;
		this.commandBarItem39.Id = 41;
		this.commandBarItem39.ItemShortcut = new DevExpress.XtraBars.BarShortcut(System.Windows.Forms.Keys.X | System.Windows.Forms.Keys.Control);
		this.commandBarItem39.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_CutLarge;
		...
		this.commandBarItem40.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_Copy;
		this.commandBarItem40.Id = 42;
		this.commandBarItem40.ItemShortcut = new DevExpress.XtraBars.BarShortcut(System.Windows.Forms.Keys.C | System.Windows.Forms.Keys.Control);
		this.commandBarItem40.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_CopyLarge;
		...
		this.commandBarItem41.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_Paste;
		this.commandBarItem41.Id = 43;
		this.commandBarItem41.ItemShortcut = new DevExpress.XtraBars.BarShortcut(System.Windows.Forms.Keys.V | System.Windows.Forms.Keys.Control);
		this.commandBarItem41.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_PasteLarge;
		...
		this.commandBarItem42.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_Undo;
		this.commandBarItem42.Id = 44;
		this.commandBarItem42.ItemShortcut = new DevExpress.XtraBars.BarShortcut(System.Windows.Forms.Keys.Z | System.Windows.Forms.Keys.Control);
		this.commandBarItem42.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_UndoLarge;
		...
		this.commandBarItem43.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_Redo;
		this.commandBarItem43.Id = 45;
		this.commandBarItem43.ItemShortcut = new DevExpress.XtraBars.BarShortcut(System.Windows.Forms.Keys.Y | System.Windows.Forms.Keys.Control);
		this.commandBarItem43.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_RedoLarge;
		...
		this.commandBarItem44.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_Zoom;
		this.commandBarItem44.Id = 46;
		this.commandBarItem44.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_ZoomLarge;
		...
		this.commandBarItem45.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_ZoomIn;
		this.commandBarItem45.Id = 47;
		this.commandBarItem45.ItemShortcut = new DevExpress.XtraBars.BarShortcut(System.Windows.Forms.Keys.Add | System.Windows.Forms.Keys.Control);
		this.commandBarItem45.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_ZoomInLarge;
		...
		this.commandBarItem46.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_ZoomOut;
		this.commandBarItem46.Id = 48;
		this.commandBarItem46.ItemShortcut = new DevExpress.XtraBars.BarShortcut(System.Windows.Forms.Keys.Subtract | System.Windows.Forms.Keys.Control);
		this.commandBarItem46.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_ZoomOutLarge;
		...
		this.recentlyUsedItemsComboBox1.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[1]
		{
		...
		this.designRepositoryItemComboBox1.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[1]
		{
			new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)
		});
		this.designRepositoryItemComboBox1.Name = "designRepositoryItemComboBox1";
		this.barDockPanelsListItem1.Caption = "Windows";
		this.barDockPanelsListItem1.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_Windows;
		this.barDockPanelsListItem1.Id = 51;
		this.barDockPanelsListItem1.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_WindowsLarge;
		...
		this.scriptsCommandBarItem1.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_Scripts;
		this.scriptsCommandBarItem1.Id = 52;
		this.scriptsCommandBarItem1.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_ScriptsLarge;
		...
		this.commandBarItem47.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_HtmlBackward;
		this.commandBarItem47.Id = 53;
		this.commandBarItem47.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_HtmlBackwardLarge;
		...
		this.commandBarItem48.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_HtmlForward;
		this.commandBarItem48.Id = 54;
		this.commandBarItem48.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_HtmlForwardLarge;
		...
		this.commandBarItem49.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_HtmlHome;
		this.commandBarItem49.Id = 55;
		this.commandBarItem49.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_HtmlHomeLarge;
		...
		this.commandBarItem50.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_HtmlRefresh;
		this.commandBarItem50.Id = 56;
		this.commandBarItem50.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_HtmlRefreshLarge;
		...
		this.commandBarItem51.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_HtmlFind;
		this.commandBarItem51.Id = 57;
		this.commandBarItem51.LargeGlyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_HtmlFindLarge;
		...
		this.printPreviewBarItem1.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_DocumentMap;
		this.printPreviewBarItem1.Id = 69;
		this.printPreviewBarItem1.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_DocumentMapLarge;
		...
		this.printPreviewBarItem2.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_Parameters;
		this.printPreviewBarItem2.Id = 70;
		this.printPreviewBarItem2.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ParametersLarge;
		...
		this.printPreviewBarItem3.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_Find;
		this.printPreviewBarItem3.Id = 71;
		this.printPreviewBarItem3.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_FindLarge;
		...
		this.printPreviewBarItem4.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_Customize;
		this.printPreviewBarItem4.Id = 72;
		this.printPreviewBarItem4.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_CustomizeLarge;
		...
		this.printPreviewBarItem5.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_Print;
		this.printPreviewBarItem5.Id = 73;
		this.printPreviewBarItem5.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_PrintLarge;
		...
		this.printPreviewBarItem6.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_PrintDirect;
		this.printPreviewBarItem6.Id = 74;
		this.printPreviewBarItem6.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_PrintDirectLarge;
		...
		this.printPreviewBarItem8.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_EditPageHF;
		this.printPreviewBarItem8.Id = 76;
		this.printPreviewBarItem8.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_EditPageHFLarge;
		...
		this.printPreviewBarItem9.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_Scale;
		this.printPreviewBarItem9.Id = 77;
		this.printPreviewBarItem9.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ScaleLarge;
		...
		this.printPreviewBarItem10.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_Pointer;
		...
		this.printPreviewBarItem11.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_HandTool;
		...
		this.printPreviewBarItem12.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_Magnifier;
		...
		this.printPreviewBarItem13.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ZoomOut;
		this.printPreviewBarItem13.Id = 81;
		this.printPreviewBarItem13.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ZoomOutLarge;
		...
		this.printPreviewBarItem14.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ZoomIn;
		this.printPreviewBarItem14.Id = 82;
		this.printPreviewBarItem14.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ZoomInLarge;
		...
		this.printPreviewBarItem15.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_Zoom;
		this.printPreviewBarItem15.Id = 83;
		this.printPreviewBarItem15.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ZoomLarge;
		...
		this.printPreviewBarItem16.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ShowFirstPage;
		this.printPreviewBarItem16.Id = 84;
		this.printPreviewBarItem16.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ShowFirstPageLarge;
		...
		this.printPreviewBarItem17.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ShowPrevPage;
		this.printPreviewBarItem17.Id = 85;
		this.printPreviewBarItem17.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ShowPrevPageLarge;
		...
		this.printPreviewBarItem18.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ShowNextPage;
		this.printPreviewBarItem18.Id = 86;
		this.printPreviewBarItem18.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ShowNextPageLarge;
		...
		this.printPreviewBarItem19.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ShowLastPage;
		this.printPreviewBarItem19.Id = 87;
		this.printPreviewBarItem19.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ShowLastPageLarge;
		...
		this.printPreviewBarItem20.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_MultiplePages;
		this.printPreviewBarItem20.Id = 88;
		this.printPreviewBarItem20.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_MultiplePagesLarge;
		...
		this.printPreviewBarItem21.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_FillBackground;
		this.printPreviewBarItem21.Id = 89;
		this.printPreviewBarItem21.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_FillBackgroundLarge;
		...
		this.printPreviewBarItem22.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_Watermark;
		this.printPreviewBarItem22.Id = 90;
		this.printPreviewBarItem22.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_WatermarkLarge;
		...
		toolTipItem82.Text = "Export the current document in one of the available formats, and save it to the file on a disk.";
		...
		this.printPreviewBarItem25.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ClosePreview;
		this.printPreviewBarItem25.Id = 93;
		this.printPreviewBarItem25.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ClosePreviewLarge;
		...
		this.printPreviewBarItem26.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_PageOrientation;
		this.printPreviewBarItem26.Id = 94;
		this.printPreviewBarItem26.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_PageOrientationLarge;
		...
		this.printPreviewBarItem27.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_PaperSize;
		this.printPreviewBarItem27.Id = 95;
		this.printPreviewBarItem27.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_PaperSizeLarge;
		...
		this.printPreviewBarItem28.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_PageMargins;
		this.printPreviewBarItem28.Id = 96;
		this.printPreviewBarItem28.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_PageMarginsLarge;
		...
		this.printPreviewBarItem29.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_SendPdf;
		this.printPreviewBarItem29.Id = 97;
		this.printPreviewBarItem29.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_SendPdfLarge;
		...
		this.printPreviewBarItem30.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_SendTxt;
		this.printPreviewBarItem30.Id = 98;
		this.printPreviewBarItem30.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_SendTxtLarge;
		...
		this.printPreviewBarItem31.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_SendCsv;
		this.printPreviewBarItem31.Id = 99;
		this.printPreviewBarItem31.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_SendCsvLarge;
		...
		this.printPreviewBarItem32.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_SendMht;
		this.printPreviewBarItem32.Id = 100;
		this.printPreviewBarItem32.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_SendMhtLarge;
		...
		this.printPreviewBarItem33.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_SendXls;
		this.printPreviewBarItem33.Id = 101;
		this.printPreviewBarItem33.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_SendXlsLarge;
		...
		this.printPreviewBarItem34.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_SendXlsx;
		this.printPreviewBarItem34.Id = 102;
		this.printPreviewBarItem34.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_SendXlsxLarge;
		...
		this.printPreviewBarItem35.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_SendRtf;
		this.printPreviewBarItem35.Id = 103;
		this.printPreviewBarItem35.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_SendRtfLarge;
		...
		this.printPreviewBarItem36.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_SendGraphic;
		this.printPreviewBarItem36.Id = 104;
		this.printPreviewBarItem36.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_SendGraphicLarge;
		...
		this.printPreviewBarItem37.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ExportPdf;
		this.printPreviewBarItem37.Id = 105;
		this.printPreviewBarItem37.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ExportPdfLarge;
		...
		this.printPreviewBarItem38.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ExportHtm;
		this.printPreviewBarItem38.Id = 106;
		this.printPreviewBarItem38.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ExportHtmLarge;
		...
		this.printPreviewBarItem39.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ExportTxt;
		this.printPreviewBarItem39.Id = 107;
		this.printPreviewBarItem39.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ExportTxtLarge;
		...
		this.printPreviewBarItem40.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ExportCsv;
		this.printPreviewBarItem40.Id = 108;
		this.printPreviewBarItem40.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ExportCsvLarge;
		...
		this.printPreviewBarItem41.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ExportMht;
		this.printPreviewBarItem41.Id = 109;
		this.printPreviewBarItem41.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ExportMhtLarge;
		...
		this.printPreviewBarItem42.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ExportXls;
		this.printPreviewBarItem42.Id = 110;
		this.printPreviewBarItem42.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ExportXlsLarge;
		...
		this.printPreviewBarItem43.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ExportXlsx;
		this.printPreviewBarItem43.Id = 111;
		this.printPreviewBarItem43.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ExportXlsxLarge;
		...
		this.printPreviewBarItem44.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ExportRtf;
		this.printPreviewBarItem44.Id = 112;
		this.printPreviewBarItem44.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ExportRtfLarge;
		...
		this.printPreviewBarItem45.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ExportGraphic;
		this.printPreviewBarItem45.Id = 113;
		this.printPreviewBarItem45.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ExportGraphicLarge;
		...
		this.printPreviewBarItem46.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_Open;
		this.printPreviewBarItem46.Id = 114;
		this.printPreviewBarItem46.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_OpenLarge;
		...
		this.printPreviewBarItem47.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_Save;
		this.printPreviewBarItem47.Id = 115;
		this.printPreviewBarItem47.LargeGlyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_SaveLarge;
		...
		this.openReportBarButtonItem.Caption = "Open template";
		this.openReportBarButtonItem.CategoryGuid = new System.Guid("6ffddb2b-9015-4d97-a4c1-91613e0ef537");
		this.openReportBarButtonItem.Id = 123;
		this.openReportBarButtonItem.LargeGlyph = Dataedo.App.Properties.Resources.documentation_open_32;
		this.openReportBarButtonItem.Name = "openReportBarButtonItem";
		toolTipTitleItem107.Text = "Open template";
		toolTipItem107.LeftIndent = 6;
		toolTipItem107.Text = "Open template for editing";
		superToolTip107.Items.Add(toolTipTitleItem107);
		superToolTip107.Items.Add(toolTipItem107);
		this.openReportBarButtonItem.SuperTip = superToolTip107;
		this.openReportBarButtonItem.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(openReportBarButtonItem_ItemClick);
		this.saveReportBarButtonItem.Caption = "Save template";
		this.saveReportBarButtonItem.Id = 124;
		this.saveReportBarButtonItem.LargeGlyph = Dataedo.App.Properties.Resources.save_32;
		this.saveReportBarButtonItem.Name = "saveReportBarButtonItem";
		toolTipTitleItem108.Text = "Save template";
		toolTipItem108.LeftIndent = 6;
		toolTipItem108.Text = "Save open template";
		superToolTip108.Items.Add(toolTipTitleItem108);
		superToolTip108.Items.Add(toolTipItem108);
		this.saveReportBarButtonItem.SuperTip = superToolTip108;
		this.saveReportBarButtonItem.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(saveReportBarButtonItem_ItemClick);
		this.xrToolboxPageCategory1.Name = "xrToolboxPageCategory1";
		this.xrToolboxPageCategory1.Pages.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPage[1] { this.ribbonPage2 });
		this.xrToolboxPageCategory1.Visible = false;
		this.ribbonPage2.Name = "ribbonPage2";
		this.ribbonPage2.Text = "Toolbox";
		this.ribbonPage2.Visible = false;
		this.ribbonPage1.Groups.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPageGroup[9] { this.xrDesignRibbonPageGroup1, this.ribbonPageGroup1, this.xrDesignRibbonPageGroup2, this.xrDesignRibbonPageGroup3, this.xrDesignRibbonPageGroup4, this.xrDesignRibbonPageGroup5, this.xrDesignRibbonPageGroup6, this.xrDesignRibbonPageGroup7, this.xrDesignRibbonPageGroup8 });
		this.ribbonPage1.Name = "ribbonPage1";
		this.ribbonPage1.Text = "Report Designer";
		this.xrDesignRibbonPageGroup1.AllowTextClipping = false;
		this.xrDesignRibbonPageGroup1.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_Report;
		...
		this.ribbonPageGroup1.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_Report;
		this.ribbonPageGroup1.ItemLinks.Add(this.openReportBarButtonItem);
		this.ribbonPageGroup1.ItemLinks.Add(this.saveReportBarButtonItem);
		this.ribbonPageGroup1.Name = "ribbonPageGroup1";
		this.ribbonPageGroup1.ShowCaptionButton = false;
		this.ribbonPageGroup1.Text = "Template";
		this.xrDesignRibbonPageGroup2.AllowTextClipping = false;
		this.xrDesignRibbonPageGroup2.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_Edit;
		...
		this.xrDesignRibbonPageGroup3.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_Font;
		...
		this.xrDesignRibbonPageGroup4.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_AlignVerticalCenters;
		...
		this.xrDesignRibbonPageGroup5.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_SizeToControl;
		...
		this.xrDesignRibbonPageGroup6.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_Zoom;
		...
		this.xrDesignRibbonPageGroup7.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_Windows;
		...
		this.xrDesignRibbonPageGroup8.Glyph = Dataedo.App.XRDesignRibbonControllerResources.RibbonUserDesigner_Scripts;
		...
		this.printPreviewRibbonPageGroup1.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_Document;
		...
		this.printPreviewRibbonPageGroup2.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_PrintDirect;
		...
		this.printPreviewRibbonPageGroup3.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_PageMargins;
		...
		this.printPreviewRibbonPageGroup4.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_Find;
		...
		this.printPreviewRibbonPageGroup5.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_Zoom;
		...
		this.printPreviewRibbonPageGroup6.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_Watermark;
		...
		this.printPreviewRibbonPageGroup7.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ExportFile;
		...
		this.printPreviewRibbonPageGroup8.Glyph = Dataedo.App.PrintRibbonControllerResources.RibbonPrintPreview_ClosePreview;
		...
		this.ribbonPage3.Groups.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPageGroup[1] { this.xrDesignRibbonPageGroup9 });
		...
		this.ribbonStatusBar1.Size = new System.Drawing.Size(1601, 27);
		this.xrDesignDockManager1.Form = this;
		this.xrDesignDockManager1.HiddenPanels.AddRange(new DevExpress.XtraBars.Docking.DockPanel[3] { this.groupAndSortDockPanel1, this.errorListDockPanel1, this.toolBoxDockPanel1 });
		...
		this.xrDesignDockManager1.RootPanels.AddRange(new DevExpress.XtraBars.Docking.DockPanel[2] { this.panelContainer2, this.propertyGridDockPanel1 });
		this.xrDesignDockManager1.TopZIndexControls.AddRange(new string[9] { "DevExpress.XtraBars.BarDockControl", "DevExpress.XtraBars.StandaloneBarDockControl", "System.Windows.Forms.StatusBar", "System.Windows.Forms.MenuStrip", "System.Windows.Forms.StatusStrip", "DevExpress.XtraBars.Ribbon.RibbonStatusBar", "DevExpress.XtraBars.Ribbon.RibbonControl", "DevExpress.XtraBars.Navigation.OfficeNavigationBar", "DevExpress.XtraBars.Navigation.TileNavPane" });
		...
		this.groupAndSortDockPanel1.OriginalSize = new System.Drawing.Size(912, 12);
		...
		this.groupAndSortDockPanel1.Size = new System.Drawing.Size(912, 163);
		...
		this.groupAndSortDockPanel1_Container.Size = new System.Drawing.Size(912, 163);
		...
		this.errorListDockPanel1.Location = new System.Drawing.Point(165, 636);
		this.errorListDockPanel1.Name = "errorListDockPanel1";
		this.errorListDockPanel1.OriginalSize = new System.Drawing.Size(200, 218);
		this.errorListDockPanel1.SavedDock = DevExpress.XtraBars.Docking.DockingStyle.Bottom;
		this.errorListDockPanel1.SavedIndex = 2;
		this.errorListDockPanel1.Size = new System.Drawing.Size(920, 218);
		...
		this.errorListDockPanel1_Container.Size = new System.Drawing.Size(912, 191);
		...
		this.toolBoxDockPanel1.Size = new System.Drawing.Size(165, 712);
		...
		this.toolBoxDockPanel1_Container.Size = new System.Drawing.Size(157, 685);
		...
		this.panelContainer2.ID = new System.Guid("2fd8796c-4c15-405d-a1ba-58e9b57df162");
		this.panelContainer2.Location = new System.Drawing.Point(0, 142);
		this.panelContainer2.Name = "panelContainer2";
		this.panelContainer2.OriginalSize = new System.Drawing.Size(449, 160);
		this.panelContainer2.Size = new System.Drawing.Size(449, 712);
		...
		this.reportExplorerDockPanel1.OriginalSize = new System.Drawing.Size(389, 657);
		this.reportExplorerDockPanel1.Size = new System.Drawing.Size(441, 657);
		...
		this.reportExplorerDockPanel1_Container.Size = new System.Drawing.Size(441, 657);
		...
		this.fieldListDockPanel1.OriginalSize = new System.Drawing.Size(389, 657);
		this.fieldListDockPanel1.Size = new System.Drawing.Size(441, 657);
		...
		this.fieldListDockPanel1_Container.Size = new System.Drawing.Size(441, 657);
		...
		this.propertyGridDockPanel1.Location = new System.Drawing.Point(852, 142);
		this.propertyGridDockPanel1.Name = "propertyGridDockPanel1";
		this.propertyGridDockPanel1.OriginalSize = new System.Drawing.Size(749, 200);
		this.propertyGridDockPanel1.Size = new System.Drawing.Size(749, 712);
		...
		this.propertyGridDockPanel1_Container.Size = new System.Drawing.Size(741, 685);
		this.propertyGridDockPanel1_Container.TabIndex = 0;
		this.reportDesigner1.ContainerControl = null;
		xRDesignPanelListener.DesignControl = this.xrDesignRibbonController1;
		...
		this.reportDesigner1.DesignPanelListeners.AddRange(new DevExpress.XtraReports.UserDesigner.XRDesignPanelListener[8] { xRDesignPanelListener, xRDesignPanelListener2, xRDesignPanelListener3, xRDesignPanelListener4, xRDesignPanelListener5, xRDesignPanelListener6, xRDesignPanelListener7, xRDesignPanelListener8 });
		this.reportDesigner1.Form = this;
		this.xtraReportOpenFileDialog.Filter = "XtraReport (*.repx)|";
		base.AutoScaleDimensions = new System.Drawing.SizeF(6f, 13f);
		base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
		base.ClientSize = new System.Drawing.Size(1601, 881);
		base.Controls.Add(this.propertyGridDockPanel1);
		...
		base.Name = "DocGeneratingForm";
		this.Text = "DocGeneratingForm";
