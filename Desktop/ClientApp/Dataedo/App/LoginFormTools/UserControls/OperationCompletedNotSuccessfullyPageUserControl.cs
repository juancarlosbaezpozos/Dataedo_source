...
public class OperationCompletedNotSuccessfullyPageUserControl : BasePageUserControl
{
	...
	private MemoEdit exceptionsTextBox;

	private EmptySpaceItem separatorEmptySpaceItem;

	public OperationCompletedNotSuccessfullyPageUserControl()
	{
		InitializeComponent();
	...
	internal override void SetParameter(object parameter, bool isCalledAsPrevious)
	{
		...
		if (repositoryOperationCompleted != null)
		{
			...
			if (repositoryOperationCompleted.Exceptions.Length > 0)
			{
				exceptionsTextBox.Visible = true;
				exceptionsTextBox.Text = repositoryOperationCompleted.Exceptions.ToString();
			}
			else
			{
				exceptionsTextBox.Visible = false;
			}
		}
	}
	...
	private void InitializeComponent()
	{
		...
		this.exceptionsTextBox = new DevExpress.XtraEditors.MemoEdit();
		...
		((System.ComponentModel.ISupportInitialize)this.exceptionsTextBox.Properties).BeginInit();
		...
		this.mainLayoutControl.OptionsCustomizationForm.DesignTimeCustomizationFormPositionAndSize = new System.Drawing.Rectangle(3548, 448, 855, 685);
		...
		this.contentPanelControl.Controls.Add(this.exceptionsTextBox);
		...
		this.exceptionsTextBox.Dock = System.Windows.Forms.DockStyle.Fill;
		this.exceptionsTextBox.Location = new System.Drawing.Point(0, 0);
		this.exceptionsTextBox.Name = "exceptionsTextBox";
		this.exceptionsTextBox.Properties.ReadOnly = true;
		this.exceptionsTextBox.Size = new System.Drawing.Size(646, 259);
		this.exceptionsTextBox.TabIndex = 11;
		this.backSimpleButton.Appearance.Font = new System.Drawing.Font("Tahoma", 8.25f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 238);
		this.backSimpleButton.Appearance.Options.UseFont = true;
		this.backSimpleButton.ImageOptions.Location = DevExpress.XtraEditors.ImageLocation.MiddleLeft;
		this.backSimpleButton.Location = new System.Drawing.Point(590, 416);
		this.backSimpleButton.MaximumSize = new System.Drawing.Size(85, 29);
		this.backSimpleButton.MinimumSize = new System.Drawing.Size(85, 29);
		this.backSimpleButton.Name = "backSimpleButton";
		this.backSimpleButton.Size = new System.Drawing.Size(85, 29);
		this.backSimpleButton.StyleController = this.mainLayoutControl;
		this.backSimpleButton.TabIndex = 20;
		...
		this.description1LabelControl.Text = "Operation failed.";
		...
		this.headerLabelControl.Text = "Operation failed";
		...
		this.connectToRepositorySimpleButtonLayoutControlItem.Control = this.backSimpleButton;
		...
		base.Name = "OperationCompletedNotSuccessfullyPageUserControl";
		...
		((System.ComponentModel.ISupportInitialize)this.exceptionsTextBox.Properties).EndInit();
