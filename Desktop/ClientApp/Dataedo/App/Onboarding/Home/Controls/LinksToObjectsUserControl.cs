...
public class LinksToObjectsUserControl : UserControl
{
	private List<LinkToObjectByIdModel> links;
	...
	public LinksToObjectsUserControl()
	{
		InitializeComponent();
	...
	public void SetParameters(List<LinkToObjectByIdModel> links)
	{
		this.links = links;
	...
	{
		List<LinkToObjectByIdModel> list = links;
	...
	{
		LinkToObjectByIdModel rowDataUnderCursor = ActionsSupport.GetRowDataUnderCursor<LinkToObjectByIdModel>(linksGridView);
		if (rowDataUnderCursor != null)
		{
			this.LinkToObjectClick?.Invoke(sender, rowDataUnderCursor);
		}
	}
	...
	private void InitializeComponent()
	{
		...
		this.linksGridControl.Location = new System.Drawing.Point(2, 38);
		...
		this.linksGridControl.Size = new System.Drawing.Size(552, 216);
		...
		this.linksGridControlLayoutControlItem.Size = new System.Drawing.Size(556, 220);
		...
		this.bottomEmptySpaceItem.Location = new System.Drawing.Point(0, 256);
		this.bottomEmptySpaceItem.MinSize = new System.Drawing.Size(104, 1);
		this.bottomEmptySpaceItem.Name = "bottomEmptySpaceItem";
		this.bottomEmptySpaceItem.Size = new System.Drawing.Size(556, 10);
		...
		base.Name = "LinksToObjectsUserControl";
