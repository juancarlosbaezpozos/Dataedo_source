...
public class PerconaConnection : ConnectionBase
{
	[XmlElement]
	...
	{
		return DatabaseType.PerconaMySQL;
	}
	...
	{
		throw new NotSupportedException("Percona repository is not supported.");
	}
