...
internal class Function : IObject
{
	internal Dataedo.App.Tools.Export.Universal.Transformers.Json.MenuTree.Function MenuTreeItem;
	...
	public string Subtype => SharedObjectSubtypeEnum.TypeToString(SharedObjectTypeEnum.ObjectType.Function, Model.Subtype);
	...
	public Function(Dataedo.App.Tools.Export.Universal.Transformers.Json.MenuTree.Function menuTreeItem)
	{
	...
	private void SetSummaryTable()
	{
		Summary = new List<SummaryField>
		{
			...
			new SummaryField("Type", SharedObjectSubtypeEnum.TypeToStringForSingle(SharedObjectTypeEnum.ObjectType.Function, Model.Subtype))
		};
