...
internal class Table : IObject
{
	internal Dataedo.App.Tools.Export.Universal.Transformers.Json.MenuTree.Table MenuTreeItem;
	...
	public string Subtype => SharedObjectSubtypeEnum.TypeToString(SharedObjectTypeEnum.ObjectType.Table, Model.Subtype);
	...
	public Table(Dataedo.App.Tools.Export.Universal.Transformers.Json.MenuTree.Table menuTreeItem)
	{
	...
	private void SetSummaryTable()
	{
		Summary = new List<SummaryField>
		{
			...
			new SummaryField("Type", SharedObjectSubtypeEnum.TypeToStringForSingle(SharedObjectTypeEnum.ObjectType.Table, Model.Subtype))
		};
