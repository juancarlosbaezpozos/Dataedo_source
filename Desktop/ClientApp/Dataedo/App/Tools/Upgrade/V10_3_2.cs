...
internal class V10_3_2
{
	private V10_3_2Base commands;

	public V10_3_2(DatabaseType databaseType, string connectionString)
	{
		commands = CommandsFactory.GetUpgradeCommands(databaseType, connectionString).V10_3_2;
	}
