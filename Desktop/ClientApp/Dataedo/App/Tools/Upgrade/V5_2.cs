...
internal class V5_2
{
	private V5_2Base commands;

	public V5_2(DatabaseType databaseType, string connectionString)
	{
		commands = CommandsFactory.GetUpgradeCommands(databaseType, connectionString).V5_2;
	}
