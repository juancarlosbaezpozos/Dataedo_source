...
internal class V6_0_3
{
	private V6_0_3Base commands;

	public V6_0_3(DatabaseType databaseType, string connectionString)
	{
		commands = CommandsFactory.GetUpgradeCommands(databaseType, connectionString).V6_0_3;
	}
