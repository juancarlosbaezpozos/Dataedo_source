...
internal class V7_0
{
	private V7_0Base commands;

	public V7_0(DatabaseType databaseType, string connectionString)
	{
		commands = CommandsFactory.GetUpgradeCommands(databaseType, connectionString).V7_0;
	}
