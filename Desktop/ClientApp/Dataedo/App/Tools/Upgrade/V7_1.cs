...
internal class V7_1
{
	private V7_1Base commands;

	public V7_1(DatabaseType databaseType, string connectionString)
	{
		commands = CommandsFactory.GetUpgradeCommands(databaseType, connectionString).V7_1;
	}
