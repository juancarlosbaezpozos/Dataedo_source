...
internal class V8_1
{
	private V8_1Base commands;

	public V8_1(DatabaseType databaseType, string connectionString)
	{
		commands = CommandsFactory.GetUpgradeCommands(databaseType, connectionString).V8_1;
	}
