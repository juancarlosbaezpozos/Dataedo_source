...
public class HiveMetastoreSQLServerConnectorControl : SQLServerConnectorControl
{
	private ButtonEdit hiveDatabaseButtonEdit;

	private LayoutControlItem hiveDatabaseLayoutControlItem;

	protected override PanelTypeEnum.PanelType PanelType => PanelTypeEnum.PanelType.HiveMetastoreSQLServer;
	...
	protected override void SetPanelNewDBRowValues(bool forGettingDatabasesList = false)
	{
		...
		base.DatabaseRow = new HiveDatabaseRow(base.SelectedDatabaseType, (!forGettingDatabasesList) ? base.providedSQLServerDatabase : base.DatabaseRow?.Param2, SelectedHiveDatabase?.CatalogName, SelectedHiveDatabase?.DatabaseName, documentationTitle, base.providedSqlServerHost, base.providedSQLServerLogin, base.providedSQLServerPassword, Authentication.IsWindowsAuthentication(base.providedSqlServerAuthenticationLookUpEdit), base.DatabaseRow.Id, base.DatabaseRow.Filter.GetRulesXml(), base.DatabaseRow.DbmsVersion, base.providedSqlServerPort, AuthenticationType.GetTypeByIndex(Authentication.GetIndex(base.providedSqlServerAuthenticationLookUpEdit)))
		{
			Param1 = SqlServerConnectionModeEnum.TypeToString(base.SqlServerConnectionMode)
		};
	}
	...
	protected override void ReadPanelValues()
	{
		...
		sqlServerDatabaseButtonEdit.Text = base.DatabaseRow.Param2;
	...
	private void hiveDatabaseButtonEdit_ButtonClick(object sender, ButtonPressedEventArgs e)
	{
		...
		SetNewDBRowValues();
		if (!HiveDatabaseRow.ValidateHiveDatabase(addDBErrorProvider, sqlServerDatabaseButtonEdit, base.SplashScreenManager, FindForm()))
		{
